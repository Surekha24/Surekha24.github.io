...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="description" content="Surekha Bhugeloo Personal Website" />
  ...
  <!-- 
	...
	Twitter: 		http://twitter.com/SurekhaB_
	...
	<div class="owl-carousel owl-carousel1 owl-carousel-fullwidth fh5co-light-arrow animate-box" data-animate-effect="fadeIn">
		<div class="item"><a href="images/rmb lobby_opt.jpg" class="image-popup"><img src="images/rmb lobby_opt.jpg" alt="image"></a></div>
		<div class="item"><a href="images/ayls1_opt.jpg" class="image-popup"><img src="images/ayls1_opt.jpg" alt="image"></a></div>
	</div>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="col-md-6 col-sm-6 services-num services-num-text-right">
						...
						<div class="desc">
							<h3>Resume</h3>
							<p>Projects past, current, future</p>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Find me on social media</h1>
						<p>instagram</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 blog-section">
					<span>03 <small>March 2018</small></span>
					<h3><a href="#"> Post 3 coming soon </a></h3>
					<p> </p>
					<a class="btn btn-primary" href="#">Read More</a>
				</div>
				<div class="col-md-4 blog-section">
					<span>02 <small>March 2018</small></span>
					<h3><a href="#">Post 2 coming soon </a></h3>
					<p> </p>
					<a class="btn btn-primary" href="#">Read More</a>
				</div>
				<div class="col-md-4 blog-section">
					<span>01 <small>March 2018</small></span>
					<h3><a href="#">Post 1 coming soon</a></h3>
					<p> </p>
					<a class="btn btn-primary" href="#">Read More</a>
				</div>
			</div>
	...
	<div class="fh5co-parallax" style="background-image: url(images/hero-2.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
					<div class="fh5co-intro fh5co-table-cell">
						<h1 class="text-center">Current motto</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center">
						<p>Copyright 2016 Free Html5. All Rights Reserved. <br>Made with by <a href="http://freehtml5.co/" target="_blank">Freehtml5.co</a> </p>
